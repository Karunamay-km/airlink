...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeAircrafts() {
        if (aircraftRepository.count() == 0) {
            ...
            Airline airIndia = airlineRepository
                .findByCodeIgnoreCase("AI")
                .orElse(null);
            Airline indigo = airlineRepository
                .findByCodeIgnoreCase("6E")
                .orElse(null);

            if (airIndia == null || indigo == null) {
                log.warn(
                    "Skipping aircraft initialization: Required Airlines (AI, 6E) not found."
                );
                return;
            }
    ...
    private void initializeFlights() {
        if (
            ...
            Airport del = airportRepository
                .findByCodeIgnoreCase("DEL")
                .orElse(null);
            Airport bom = airportRepository
                .findByCodeIgnoreCase("BOM")
                .orElse(null);
            Airport blr = airportRepository
                .findByCodeIgnoreCase("BLR")
                .orElse(null);

            Aircraft a320 = aircraftRepository
                .findByRegistrationNumberIgnoreCase("VT-AI1")
                .orElse(null);
            Aircraft b738 = aircraftRepository
                .findByRegistrationNumberIgnoreCase("VT-IN2")
                .orElse(null);
            Aircraft b787 = aircraftRepository
                .findByRegistrationNumberIgnoreCase("VT-AI3")
                .orElse(null);
            ...
            if (
                ...
                log.warn(
                    "Skipping flight initialization: Required Airlines, Airports, or Aircraft not found."
                );
                return;
            }
            ...
            log.info(
                "Flights already exist or dependencies are missing. Skipping flight data initialization."
            );
        }
    }
    ...
    private void initializeRoles() {
        if (roleRepository.count() == 0) {
            ...
            Set<Permission> userReadPermissions =
            ...
            roleRepository.saveAll(
                Arrays.asList(adminRole, userRole, moderatorRole)
            );
