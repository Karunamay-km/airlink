...
public class PassengerMapper {
    ...
    public PassengerResponseDTO toBasicResponseDTO(Passenger passenger) {
        ...
        Long seatId = passenger.getSeat() != null
            ? passenger.getSeat().getId()
            : null;
        String seatNo = passenger.getSeat() != null
            ? passenger.getSeat().getSeatNo()
            : null;
        ...
        return PassengerResponseDTO.builder()
            ...
            .govtIdNo(passenger.getGovtIdNo())
            .dob(passenger.getDob())
            .gender(passenger.getGender())
            .email(passenger.getEmail())
            .phone(passenger.getPhone())
            .checkedBagCount(passenger.getCheckedBagCount())
            .seat(seatMapper.toBasicResponseDTO(passenger.getSeat()))
            // .seatId(seatId)
            // .seatNo(seatNo)
            .build();
    }
    ...
    public PassengerResponseDTO toResponseDTO(Passenger passenger) {
        ...
        Long bookingId = passenger.getBooking() != null
    ...
    public PageResponseDTO<PassengerResponseDTO> toPageResponseDTO(
        ...
        return pageMapper.toPageResponse(
            passengerPage,
            this::toBasicResponseDTO
        );
    }

    public void updateEntityFromRequest(
        Passenger passenger,
        PassengerRequestDTO requestDTO
    ) {
